...
(function () {
  ...
  function getChartData(currentUser) {
    ...
    angular.forEach(currentUser.timesheets, function (value, key) {
  ...
  angular.module('ytcwebUirouteApp').factory('UserRole', UserResource).factory('UserTimeSeriesChart', getChartData);
})();
