...
(function () {
  ...
  function AuthService($location, $http, $cookies, $q, appConfig, Util, User) {
    ...
    var Auth = {
      ...
      createUser: function createUser(user, callback) {
        ...
        function (data) {//this was removed to automatically NOT login the new user.
        }, function (err) {
          Auth.logout();
      ...
      isContractor: function isContractor() {
        return Auth.hasRole.apply(Auth, [].concat.apply(['contractor'], arguments));
      },

      isClient: function isClient() {
        return Auth.hasRole.apply(Auth, [].concat.apply(['client'], arguments));
      },

      /**
       * Check if a user is an contractor
       *   (synchronous|asynchronous)
       *
       * @param  {Function|*} callback - optional, function(is)
       * @return {Bool|Promise}
       */
      isNavContractor: function isNavContractor() {

        return Auth.getCurrentUser().role == "contractor";
        //return Auth.hasRole
        //  .apply(Auth, [].concat.apply(['contractor'], arguments));
      },
      isNavClient: function isNavClient() {
  ...
  angular.module('ytcwebUirouteApp.auth').factory('Auth', AuthService);
})();
//},
